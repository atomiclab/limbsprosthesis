...
// author     : Gino Tubaro
// license    : MIT License
// description: Conector de los costados de la palma, parametros X e Y de alargar y ensanchar, en ese orden.
// file       : palmconnector.jscad

function main() {
   var o = [];

   for(var i=0; i<360; i++) {           // -- shell like
      var x = sin(i)*10;
      var y = cos(i)*10;
      var z = i/90;

      o.push(cube({size: (2)}).translate([x,y,z]));
